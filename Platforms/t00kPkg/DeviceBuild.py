...
# Copyright (c) ASUS ZenFone 5 Lite A502CG firmware port contributors.
# SPDX-License-Identifier: BSD-2-Clause-Patent
##
#
# t00kPkg - ASUS ZenFone 5 Lite A502CG/T00K (Clover Trail+) device build script.
#
...
#
#   python3 Platforms/t00kPkg/DeviceBuild.py                  # DEBUG, CLANGPDB, IA32
#   python3 Platforms/t00kPkg/DeviceBuild.py TARGET=RELEASE
#   python3 Platforms/t00kPkg/DeviceBuild.py TARGET=RELEASE KDNET_USB=1
#   python3 Platforms/t00kPkg/DeviceBuild.py -j 8
#
# stuart lifecycle hooks are also available:
#
#   python3 Platforms/t00kPkg/DeviceBuild.py --setup     # stuart_setup
#   python3 Platforms/t00kPkg/DeviceBuild.py --update    # stuart_update
#
# The produced flashable image is out/boot_t00k_<TARGET>.img (same path and
...
# ------------------------------------------------------------------------------
# Static platform facts (mirror of the [Defines] section of t00kPkg.dsc)
# ------------------------------------------------------------------------------
...
# Build/t00kPkg/<TARGET>_<TOOLCHAIN>/FV/<FD_NAME>.fd
FD_NAME = "T00K"
...
TARGET_TXT_CONTENT = """\
#
# Conf/target.txt - edk2 build defaults for the t00kPkg (ASUS ZenFone 5 Lite
# A502CG) firmware build.
#
# Managed by Platforms/t00kPkg/DeviceBuild.py (SetPlatformEnv).  The stuart
...
#
#ACTIVE_PLATFORM       = Platforms/t00kPkg/t00kPkg.dsc
#TARGET                = DEBUG
#TARGET_ARCH           = IA32
...
class CommonPlatform:
    ...
    # Platforms/t00kPkg/DeviceBuild.py -> Platforms/t00kPkg -> Platforms -> root
    ...
    # resolvable by its bare name (t00kPkg) - required by edk2 BaseTools
...
# Falls back to FD_NAME ("T00K") if the FDF is unavailable.
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        # KDNET-over-USB variant: mirrors 'KDNET_USB=1 ./build.sh t00k DEBUG'.
        ...
        if current != TARGET_TXT_CONTENT:
            ...
            logging.info("==> (Re)wrote Conf/target.txt with t00kPkg-safe defaults")
