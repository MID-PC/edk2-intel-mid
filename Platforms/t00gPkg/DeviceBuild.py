...
# Copyright (c) ASUS ZenFone 6 T00G firmware port contributors.
# SPDX-License-Identifier: BSD-2-Clause-Patent
##
#
# t00gPkg - ASUS ZenFone 6 A600CG/T00G (Clover Trail+) device build script.
#
...
#
#   python3 Platforms/t00gPkg/DeviceBuild.py --setup     # stuart_setup
#   python3 Platforms/t00gPkg/DeviceBuild.py --update    # stuart_update
#
# The produced flashable image is out/boot_t00g_<TARGET>.img (same path and
...
# ------------------------------------------------------------------------------
# Static platform facts (mirror of the [Defines] section of t00gPkg.dsc)
# ------------------------------------------------------------------------------
...
# Build/t00gPkg/<TARGET>_<TOOLCHAIN>/FV/<FD_NAME>.fd
FD_NAME = "T00G"
...
TARGET_TXT_CONTENT = """\
#
# Conf/target.txt - edk2 build defaults for the t00gPkg (ASUS ZenFone 6 T00G)
# firmware build.
#
# Managed by Platforms/t00gPkg/DeviceBuild.py (SetPlatformEnv).  The stuart
...
class CommonPlatform:
    ...
    # Platforms/t00gPkg/DeviceBuild.py -> Platforms/t00gPkg -> Platforms -> root
    ...
    # resolvable by its bare name (t00gPkg) - required by edk2 BaseTools
...
# Falls back to FD_NAME ("T00G") if the FDF is unavailable.
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        if current != TARGET_TXT_CONTENT:
            ...
            logging.info("==> (Re)wrote Conf/target.txt with t00gPkg-safe defaults")
